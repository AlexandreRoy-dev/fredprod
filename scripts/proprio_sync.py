#!/usr/bin/env python3
"""Sync Frédéric Roy listings from Proprio Direct + Centris photo galleries.
...
DEFAULT_AGENT_URL = "https://propriodirect.com/frederic-roy/"
USER_AGENT = (
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Sync Proprio Direct listings + Centris galleries for Frédéric Roy."
    )
